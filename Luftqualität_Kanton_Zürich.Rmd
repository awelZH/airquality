...
if (update_data) {
  ...
  source("R/auxiliary_data_constants.R", encoding = "UTF-8")
  source("R/airquality_rasterdata.R", encoding = "UTF-8")
  source("R/emissions.R", encoding = "UTF-8")
  source("R/airquality_monitoring.R", encoding = "UTF-8")
  source("R/exposition.R", encoding = "UTF-8")
