# To-Do:
# ---
# any solution to get get population data, NH3, Ndep, Ndep_exeedance as rasterdata from an api instead of local or remote files?
# finale Belastungskarten inkl O3 von Geolion mit allen verfügbaren Jahren
# Datensätze gezielt für Statistikamt-Visualisierungen abspeichern
# ... NO2_PS Airmo Abfrage: Bauma Oberstufen, Wald Feuerwehr, Zürich Bullingerhof sobald 2023 verfügbar
...
### - retrieved on 11.01.2024
files$airquality$monitoring$nabel_due_h1 <- "airquality_monitoring/nabel_tse_due_h1.txt"
files$airquality$monitoring$nabel_kas_h1 <- "airquality_monitoring/nabel_tse_zue_h1.txt"

### Selected ozone (O3) monitoring data Kanton Zürich from intercantonal monitoring network OSTLUFT (hourly values)
### - source: OSTLUFT
### - derived as (open) data from: direct export by OSTLUFT (can be in principal downloaded as open data from https://www.ostluft.ch/index.php?id=datenabfragen, but only for smaller queriesy)
### - retrieved on 18.12.2023
files$airquality$monitoring$ostluft_h1 <- "airquality_monitoring/ostluft_airmo_h1_kanton_zurich.csv"
...
files$rasterdata$bfs_pop$"2015" <- "bfs_statpop/STATPOP2015.csv"
files$rasterdata$bfs_pop$"2020" <- "bfs_statpop/STATPOP2020.csv"
files$rasterdata$bfs_pop$"2021" <- "bfs_statpop/STATPOP2021.csv"
files$rasterdata$bfs_pop$"2022" <- "bfs_statpop/STATPOP2022.csv"
