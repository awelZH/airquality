...
# FIXME: für emikat gibt es zwei links??
...
get_wfs_metadata <- function(apiurl){
  
  url <- httr2::url_parse(apiurl, version = "2.0.0", crs = 2056)
...
get_wcs_metadata <- function(apiurl, typ){
