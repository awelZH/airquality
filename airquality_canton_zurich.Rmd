...
if (update_data) {
  ...
  source("R/01_packages.R", encoding = "UTF-8")
  source("R/02_functions.R", encoding = "UTF-8")
  source("R/03_auxiliary.R", encoding = "UTF-8")
  source("R/04_emissions.R", encoding = "UTF-8")
  source("R/05_airquality_monitoring.R", encoding = "UTF-8")
  source("R/06_airquality_rasterdata.R", encoding = "UTF-8")
  source("R/07_exposition.R", encoding = "UTF-8")
  ...
  plots <- readRDS("data/output/ggplots.rds")
