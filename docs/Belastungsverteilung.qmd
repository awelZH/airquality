...
<!-- get_plot(plots, "pollutant == 'rel_various' & source == 'population_over_thresh'") -->
<!-- ``` -->

```{r}
#| label: fig-population-over-thresh-ts
#| fig.asp: 0.6
get_plot(plots, "pollutant == 'timeseries_various' & source == 'population_over_thresh'")
```


```{r}
p <- get_plot(plots, "pollutant == 'timeseries_various' & source == 'population_over_thresh'")
p$data |> 
