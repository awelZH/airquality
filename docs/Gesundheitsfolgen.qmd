...
withr::with_dir("..", {
  ...
  source("scripts/_plot_outcomes.R", encoding = "UTF-8")
})
...
print_tabset(list(
  ...
  "pro Todesfall" = get_plot(plots, "life_years_lost_per_death", "PM2.5")
))
```
...
print_tabset(list(
  ...
  "pro Todesfall" = get_plot(plots, "life_years_lost_per_death", "NO2")
))
```
...
print_tabset(list(
  ...
  "pro Todesfall" = get_plot(plots, "life_years_lost_per_death", "O3_peakseason_mean_d1_max_mean_h8gl")
))
```
