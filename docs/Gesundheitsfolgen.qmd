...
::: {.callout-note collapse="true"}
### Gesundheitsfolgen unterschiedlicher Schadstoffe sollten nicht aufsummiert werden
...
In der vorliegenden Berechnung richten wir uns nach dem etablierten epidemiologischen Vorgehen (vergleiche z.B. [Castro et al., 2023](https://edoc.unibas.ch/96059/)). Die Ergebnisse sind somit methodisch konsistent mit anderen Studien in der Schweiz und international. Wir nutzen Dosis-Wirkungsbeziehungen und Schwellenwerte, die dem aktuellen Stand der Wissenschaft entsprechen und möglichst repräsentativ für die Schweizer Bevölkerung sind. Dafür richten wir uns nach den Empfehlungen der Schweizer [Dokumentationsstelle Luftverschmutzung und Gesundheit (LUDOK)](https://www.swisstph.ch/de/projects/ludok).
