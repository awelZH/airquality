...
airquality.methods::print_tabset(list(
  absolut = airquality.methods::get_plot(plots, "preliminary_deaths_abs", "PM2.5"),
  relativ = airquality.methods::get_plot(plots, "preliminary_deaths_rel", "PM2.5")
))
```
...
#| output: asis
airquality.methods::print_tabset(list(
  absolut = airquality.methods::get_plot(plots, "life_years_lost_abs", "PM2.5"),
  relativ = airquality.methods::get_plot(plots, "life_years_lost_rel", "PM2.5")
))
```
...
#| output: asis
airquality.methods::print_tabset(list(
  absolut = airquality.methods::get_plot(plots, "preliminary_deaths_abs", "NO2"),
  relativ = airquality.methods::get_plot(plots, "preliminary_deaths_rel", "NO2")
))
```
...
#| output: asis
airquality.methods::print_tabset(list(
  absolut = airquality.methods::get_plot(plots, "life_years_lost_abs", "NO2"),
  relativ = airquality.methods::get_plot(plots, "life_years_lost_rel", "NO2")
))
```
...
#| output: asis
airquality.methods::print_tabset(list(
  absolut = airquality.methods::get_plot(plots, "preliminary_deaths_abs", "O3_peakseason_mean_d1_max_mean_h8gl"),
  relativ = airquality.methods::get_plot(plots, "preliminary_deaths_rel", "O3_peakseason_mean_d1_max_mean_h8gl")
))
```
...
#| output: asis
airquality.methods::print_tabset(list(
  absolut = airquality.methods::get_plot(plots, "life_years_lost_abs", "O3_peakseason_mean_d1_max_mean_h8gl"),
  relativ = airquality.methods::get_plot(plots, "life_years_lost_rel", "O3_peakseason_mean_d1_max_mean_h8gl")
))
```
